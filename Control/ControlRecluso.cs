...
namespace Control {
  ...
  public class ControlRecluso {
    ...
    /// </summary>
    private DatosRecluso _datosRecluso = new DatosRecluso();
    /// <summary>
    ...
    public bool GuardarRecluso(string codigo, string nombre, string apellido, string genero, DateTime fecha, int idExpediente, string cedula) {
      if (BuscarRecluso(cedula) == null) {
        Expediente exp = _datosRecluso.BuscarExpediente(cedula);
        _recluso = new Recluso(nombre, apellido, genero, fecha, cedula, codigo, exp);
        _datosRecluso.InsertarRecluso(_recluso);
        return true;
      } else {
    ...
    public Object BuscarRecluso(string cedula) {
      return _datosRecluso.BuscarRecluso(cedula);
    }
    /// <summary>
    ...
    public List<Object> ListarCargos(string codigoExpediente) {
      List<Cargo> cargos = _datosRecluso.ConsultarCargos(codigoExpediente);
    ...
    /// <summary>
    /// Actualiza los datos del recluso.
    /// </summary>
    /// <param name="codigo">Id del recluso para identificarlo en base.</param>
    /// <param name="nombre">Nombre del recluso</param>
    /// <param name="apellido">Apellido del usuario</param>
    /// <param name="genero">Género del recluso</param>
    /// <param name="fecha">Fecha de nacimiento del recluso</param>
    /// <param name="idExpediente">Id del expediente del recluso en base</param>
    /// <param name="cedula">Cédula del recluso </param>
    /// <returns>Si se actualizaron lso datos con éxito devuelve <see cref="true"/>, si no, devuelve <see cref="false"/>.</returns>
    public bool ActualizarRecluso(string codigo, string nombre, string apellido, string genero, DateTime fecha, int idExpediente, string cedula) {
      Expediente exp = _datosRecluso.BuscarExpediente(cedula);
      _recluso = new Recluso(nombre, apellido, genero, fecha, cedula, codigo, exp);

      try {
        _datosRecluso.ActualizarRecluso(_recluso);
        return true;
