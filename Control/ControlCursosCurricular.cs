...
namespace Control {
  ...
  public class ControlCursosCurricular {
    ...
    /// </summary>
    private DatosCursoCurricular _datosCurso = new DatosCursoCurricular();
    /// <summary>
    /// Instancia de <see cref="ActividadCurricular"/> sirve como auxiliar para los métodos de control.
    /// </summary>
    private ActividadCurricular _curricular = null;
    ...
    public List<Object> FiltrarDescripcionModalidad(string descripcion, string modalidad) {
      List<ActividadCurricular> CursosCurriculares = _datosCurso.BuscarDescripcionModalidadEstudio(descripcion, modalidad);
      if (CursosCurriculares == null) {
